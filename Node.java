...
//      System.out.println("Evaluating node " + id + " of kind " + kind );
      ...
      */
         ...
         if ( member( funcName, bif0 ) ) {
            ...
            if ( first.first.isKind("num") ) {
             double arg1 = first.first.evaluate();
             double[] args = first.second.evaluate();
            }
            else {
             double[] args = first.first.evaluate();
            }
   ...
   private final static String[] bif1 = { "ins", "first", "rest", "null", 
